    ...
    def test_container_html(self):
        self._test_html_content(
            ...
            expected_breadcrumbs=(
                ...
                section_parameters=re.escape(u'?show={}'.format(http.urlquote(str(self.chapter.location).encode()))),
                subsection_parameters=re.escape(u'?show={}'.format(http.urlquote(str(self.sequential.location).encode()))),
            ),
        )
